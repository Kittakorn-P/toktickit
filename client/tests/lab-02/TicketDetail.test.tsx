...
describe("TicketDetail", () => {
  it("renders owned ticket details and attachments", async () => {
    ...
    vi.spyOn(api, "getAttachments").mockResolvedValue([
      { id: 1, originalFilename: "screenshot.png", mimeType: "image/png", sizeBytes: 1000, isRemoved: false, removedAt: null, createdAt: "2026-01-01T00:00:00Z" },
    ]);
  ...
  it("removes an attachment after confirmation and hides its download/remove buttons", async () => {
    ...
    vi.spyOn(api, "getAttachments")
      ...
      .mockResolvedValueOnce([
        { id: 1, originalFilename: "screenshot.png", mimeType: "image/png", sizeBytes: 1000, isRemoved: true, removedAt: "2026-01-02T00:00:00Z", createdAt: "2026-01-01T00:00:00Z" },
      ]);
